...
function init(config, watch, options) {
  ...
  keycloak.onAuthSuccess = function () {
    ...
    typeof options.onAuthSuccess === "function" &&
      watch.$emit("authSuccess", options.onAuthSuccess.bind(this, keycloak));
  };
  keycloak.onAuthRefreshSuccess = function () {
    updateWatchVariables(true);
  };
  keycloak.init(options.init).error((err) => {
